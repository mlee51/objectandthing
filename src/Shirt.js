...
function ArWing(props) {
  ...
  return (
    ...
    <group  {...props}  ref={group} rotation={[-3.14*0.5,3.14,3.14]} scale={[3,3,3]}>
      <a.mesh onMouseEnter={() => console.log("hi")} onClick={() => window.open("https://google.com")}  rotation={[0,0,0]} scale={props2.scale}  visible geometry={gltf.nodes.Shirt_on_Hanger_1.geometry} onPointerOver={(e) => setHover(true)}
